...
def main():
    ...
    parser.add_argument("--transient-for", action="store", type=int,
                      dest="xid", default="0",
                      help=_("The X Window ID of the calling application"))
    parser.add_argument("--interaction", type=str, dest="interaction", default="show-confirm-search",
                      help=_("Whether to ask the user to confirm installation or not (currently ignored)"))
    parser.add_argument("--desktop-id", type=str, dest="desktop_id", default=None,
                      help=_("The .desktop file of the calling application (currently ignored)"))
    parser.add_argument("--startup-notification-id", type=str,
                      dest="startup_notification_id", default=None,
                      help=_("An X11-style startup notification ID"))
    parser.add_argument("codec", nargs="+", help=_("The codec to install (currently ignored)"))
    options = parser.parse_args()
    installer = GStreamerInstaller(options.xid, options.codec)
